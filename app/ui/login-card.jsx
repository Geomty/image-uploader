...
export default function LoginCard() {
  return (
    <div className="md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:w-fit md:h-fit w-full h-full p-12 flex flex-col items-center justify-center
